...
| tesseract.js 7.0.0 + its worker, WebAssembly core (tesseract.js-core 7.0.0) and English language data (@tesseract.js-data/eng 1.0.0), all pinned | cdn.jsdelivr.net | Screenshot OCR |
